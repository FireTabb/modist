export class sortAndFilterView {
  sortAndFilterHandler() {
    const filterAndSortWraper = document.querySelector(
      ".filter-and-sort__wraper",
    );
    ...
    const filterWindowClose = document.querySelector(
      "#filter-window__close-btn",
    );
...
export default new sortAndFilterView();
